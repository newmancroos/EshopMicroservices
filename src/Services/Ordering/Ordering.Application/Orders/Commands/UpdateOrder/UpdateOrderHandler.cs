...
public class UpdateOrderHandler(IApplicationDbContext dbContext) : IRequestHandler<UpdateOrderCommand, UpdateOrderResult>
{
    ...
    private void UpdateOrderWithNewValues(Order order, OrderDto orderDto)
    {
        ...
        order.Update(
            ...
            statyus: orderDto.Status
            );
        //foreach (var orderItemDto in orderDto.OrderItems)
        //{
        //    order.OrderItems.Add(ProductId.Of(orderItemDto.ProductId), orderItemDto.Quantity, orderItemDto.Price);
        //}
    }
}
